...
var _forgetPassword = _interopRequireDefault(require("../models/forget-password.js"));
      ...
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _forgetPassword["default"].findByPk(forgetPasswordId);
      ...
      return _regenerator["default"].wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _forgetPassword["default"].create(forgetPassword);
      ...
      return _regenerator["default"].wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return _forgetPassword["default"].destroy({
                where: {
                  id: forgetPasswordId
                }
              });
...
var _default = ForgetPasswordRepo;
